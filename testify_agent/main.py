...
def parse_args():
    ...
    group.add_argument(
        ...
        action="store_true",
        default=False,
        help="If set, testify-agent will only generate tests based on the diff between branches. Default: False. Not compatible with --use-report-coverage-feature-flag.",
    )
