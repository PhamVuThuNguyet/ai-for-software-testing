...
"""
    ...
    # auto-generated by Testify Agent
    def test_try_fix_yaml_snippet_extraction(self):
        from testify_agent.utils import try_fix_yaml
...
test_name:"""
    ...
    def test_parse_args_full_repo_defaults_with_imports(self):
        ...
        from testify_agent.utils import parse_args_full_repo
    ...
    def test_find_test_files(self, mocker):
        ...
        from testify_agent.utils import find_test_files
        ...
        mocker.patch("testify_agent.utils.is_forbidden_directory", return_value=False)
        mocker.patch("testify_agent.utils.filename_to_lang", return_value="python")
    ...
    def test_find_test_files_with_forbidden_dirs(self, mocker):
        ...
        mocker.patch("os.walk", return_value=mock_os_walk)
        mocker.patch(
            "testify_agent.utils.is_forbidden_directory", side_effect=mock_is_forbidden
        )
        mocker.patch("testify_agent.utils.filename_to_lang", return_value="python")
