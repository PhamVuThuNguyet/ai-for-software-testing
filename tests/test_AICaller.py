...
class TestAICaller:
    ...
    @patch("testify_agent.AICaller.AICaller.call_model")
    ...
    @patch("testify_agent.AICaller.litellm.completion")
    ...
    @patch("testify_agent.AICaller.Trace.log")
    def test_call_model_wandb_logging(self, mock_log, mock_completion, ai_caller):
        ...
        prompt = {"system": "", "user": "Hello, world!"}
        with patch(
            "testify_agent.AICaller.litellm.stream_chunk_builder"
        ) as mock_builder:
