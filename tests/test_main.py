...
from testify_agent.main import main, parse_args
...
class TestMain:
    ...
    @patch("testify_agent.main.TestifyAgent")
    @patch("testify_agent.main.parse_args")
    @patch("testify_agent.main.os.path.isfile")
    def test_main_calls_agent_run(
        self, mock_isfile, mock_parse_args, mock_testify_agent
    ):
        args = argparse.Namespace(
            source_file_path="test_source.py",
            test_file_path="test_file.py",
        ...
        mock_testify_agent.return_value = mock_agent_instance

        main()

        mock_testify_agent.assert_called_once_with(args)
