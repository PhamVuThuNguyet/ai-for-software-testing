...
from testify_agent.CoverageProcessor import CoverageProcessor
...
class TestCoverageProcessor:
    ...
    def test_returns_empty_lists_and_float(self, mocker):
        ...
        mocker.patch(
            "testify_agent.CoverageProcessor.CoverageProcessor.extract_package_and_class_java",
            return_value=("com.example", "Example"),
        )
        mocker.patch(
            "testify_agent.CoverageProcessor.CoverageProcessor.parse_missed_covered_lines_jacoco_xml",
            return_value=(0, 0),
        )
    ...
    def test_process_coverage_report(self, mocker):
        mock_verify = mocker.patch(
            "testify_agent.CoverageProcessor.CoverageProcessor.verify_report_update"
        )
        mock_parse = mocker.patch(
            "testify_agent.CoverageProcessor.CoverageProcessor.parse_coverage_report",
            return_value=([], [], 0.0),
        )
    ...
    def test_parse_coverage_report_lcov_with_feature_flag(self, mocker):
        mock_parse_lcov = mocker.patch(
            "testify_agent.CoverageProcessor.CoverageProcessor.parse_coverage_report_lcov",
            return_value=([], [], 0.0),
        )
        processor = CoverageProcessor(
    ...
    def test_parse_coverage_report_cobertura_with_feature_flag(self, mocker):
        mock_parse_cobertura = mocker.patch(
            "testify_agent.CoverageProcessor.CoverageProcessor.parse_coverage_report_cobertura",
            return_value=([], [], 0.0),
        )
        processor = CoverageProcessor(
    ...
    def test_parse_coverage_report_jacoco(self, mocker):
        mock_parse_jacoco = mocker.patch(
            "testify_agent.CoverageProcessor.CoverageProcessor.parse_coverage_report_jacoco",
            return_value=([], [], 0.0),
        )
        processor = CoverageProcessor(
