        ...
        with tempfile.NamedTemporaryFile(
            ...
            with patch.object(generator, "ai_caller") as mock_ai_caller:
                ...
                error_message = generator.extract_error_message(
                    stderr="stderr content", stdout="stdout content"
                )
    ...
    def test_extract_error_message_with_prompt_builder(self):
        with tempfile.NamedTemporaryFile(
            ...
            with patch.object(
                ...
                error_message = generator.extract_error_message(
                    stderr="AssertionError: assert False", stdout="test_example failed"
                )

                assert (
                    error_message
                    == "Test failed due to assertion error in test_example"
                )
